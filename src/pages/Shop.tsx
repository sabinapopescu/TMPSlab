...
export default function Shop() {
  ...
  const filteredProducts = useMemo(() => {
    ...
    return filtered;
  }, [selectedMetal, selectedPearlSize, inStockOnly, sortBy]);
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mb-8">
          ...
          <p className="text-graphite text-lg">
            Descoperă colecția completă de bijuterii artizanale din perle
          </p>
        </div>
          ...
          <div className="flex-1">
            ...
            {filteredProducts.length === 0 && (
              <div className="text-center py-16">
                <p className="text-graphite text-lg">Nu am găsit produse care să corespundă filtrelor tale.</p>
                <Button
                  variant="outline"
                  className="mt-4"
                  onClick={() => {
